...
exports.SINGLE_TASKS = (userId, taskId) => `SELECT * FROM tasks WHERE user_id = ${userId} AND task_id = ${taskId}`; //? is valid syntax to fill in whatever you need in the moment
